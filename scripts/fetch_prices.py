...
def fetch_gbp() -> dict:
    prompt = (
        "Bugün serbest piyasada 1 İngiliz Sterlini (GBP) kaç Türk Lirası (TRY)? "
        "canlidoviz.com/doviz-kurlari/ingiliz-sterlini adresinden kontrol et. "
        "Alış ve satış kurunu ver. "
        "SADECE şu JSON formatında cevap ver, başka hiçbir metin ekleme: "
        '{"alis": <sayi>, "satis": <sayi>, "tarih": "<YYYY-MM-DD>"} '
        "Ondalık için nokta kullan, virgül kullanma."
    )
